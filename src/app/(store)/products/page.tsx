            ...
            {Array.from({ length: 5 }).map((_, i) => (
              ...
              >
                ...
                <div className="flex border-y border-border/30 py-3">
                  {[1, 2, 3].map((j) => (
                    <div key={j} className="flex-1 text-center space-y-1">
                      <div className="h-5 w-10 mx-auto rounded bg-muted animate-pulse" />
                      <div className="h-2 w-14 mx-auto rounded bg-muted animate-pulse" />
                    </div>
                  ))}
                </div>
              </div>
